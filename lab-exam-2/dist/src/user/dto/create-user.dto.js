...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^[a-zA-Z\s]+$/, { message: 'Full name must be alphabetic' }),
...
__decorate([
    ...
    (0, class_validator_1.Length)(11, 15),
...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^(?=.*[a-zA-Z])(?=.*\d)[a-zA-Z\d]{8,}$/, { message: 'Password must be alphanumeric and between 8 to 20 characters' }),
    __metadata("design:type", String)
